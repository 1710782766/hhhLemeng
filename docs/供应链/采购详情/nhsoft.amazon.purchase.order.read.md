...
|------|------|
| 接口名称 | 采购订单读取 |
| 接口方法 | nhsoft.amazon.purchase.order.read |
| 接口版本 | V1 |
| 最后更新时间 | 2026-03-03 23:30:23 |
| 请求方式 | GET |
| 接口地址 | https://cloud.nhsoft.cn/api/nhsoft.amazon.purchase.order.read |
| 接口子系统 | 乐檬零售 |
...
|----------|----------|------|----------|------|------|--------|
| purchase_order_fid | string | 否 | 采购订单号(和外部流水号二选一) | | | PO2030990000001 |
| purchase_order_bill_no | string | 否 | 外部流水号(和采购订单号二选一) | | | A0001 |
