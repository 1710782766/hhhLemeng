...
|------|------|
| 接口名称 | 供应商查询 |
| 接口方法 | nhsoft.amazon.basic.supplier.find |
| 接口版本 | V1 |
| 最后更新时间 | 2026-03-03 23:30:24 |
| 请求方式 | GET |
| 接口地址 | https://cloud.nhsoft.cn/api/nhsoft.amazon.basic.supplier.find?branch_num=99 |
| 接口子系统 | 乐檬零售 |
...
| supplier_settle_day_of_month | integer | 月结日期(废弃) | 10 |
| supplier_settle_days | string | 月结日期 | 10,11 |
...
| supplier_tax | number | 进项税率 | 0.03 |
| supplier_taxpayer_type | string | 纳税人类型 | 小规模纳税人 |
| supplier_shared_branches | array<integer> | 共享范围（指定门店）查询接口暂不可用 | 2072001 |
| supplier_share_regions | array<integer> | 共享范围（指定区域）查询接口暂不可用 | 1 |
...
```json
{
  ...
  "supplier_shared_branches": "2072001",
  "supplier_share_regions": "1",
